...
CREATE TABLE `club_notification`  (
  ...
  `link` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '通知相关页面的链接（可选）',
...
) ENGINE = InnoDB AUTO_INCREMENT = 2423 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `club_post_comment`  (
  ...
  `type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '类型（评论：comment, 回复：reply）',
